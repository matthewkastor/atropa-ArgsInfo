...
```
var ArgsInfo = require('atropa-ArgsInfo').ArgsInfo;
console.log(ArgsInfo);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-ArgsInfo_web.js` in your page and
 `atropa.ArgsInfo` will be available in your page.
...
To run the browser tests open `browser/atropa-ArgsInfo_tests.html` in your
...
If you alter the source in `src/atropa-ArgsInfo.js` please run the
